...
def login():
    ...
    if request.method == 'POST':
        ...
        data = readData('SELECT password FROM Users Where email =' +"'"+email+"'")
...
def sign_up():
    ...
    if request.method == 'POST':
        ...
        elif readData('SELECT * FROM Users WHERE email = '+"'"+email+"'"):
...
def search():
    ...
    if request.method == 'POST' :
        ...
        if reportType and reportOfferId:
            reportTypeId = 8
            ...
            flash(f'Raported offer! Thank You for your support.', category='success')
            ...
            return render_template('search.html', data = all_data, csession=True)
